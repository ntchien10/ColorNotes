package com.example.sqlite_2nd;
...
import com.example.sqlite_2nd.Adapter.CustomAdapter;
import com.example.sqlite_2nd.Data.DBManager;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setAdapter() {
        if (customAdapter == null) {
            customAdapter = new CustomAdapter(this, R.layout.list_item_student, studentList);
